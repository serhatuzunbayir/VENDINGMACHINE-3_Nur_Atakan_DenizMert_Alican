    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception c)
            {
                ...
                MessageBox.Show("Please insert the coin !\n","FAIL", MessageBoxButtons.OK);
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked == true)//Coca Cola Classic
            {
                ...
                int count_update=Calculate(price, name, count);
        ...
        public int Calculate(double price, string name, int count)
        {
            if (count != 0 && x >= price)
            {
                x -= price;
                count--;
                label10.Text = x.ToString();
                DialogResult d = MessageBox.Show("Product is preparing !\n Take " + x + "TL Back in Charge !", "SUCCESS", MessageBoxButtons.OK);
